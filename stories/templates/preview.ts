...
export function getPreview(folderName: string, fileName: string, {
  ...
  const reactCode = require(`!!raw-loader!../../packages/react-infinitegrid/stories/${folderName}/apps/React${fileName}App`).default;
  let ngxComponentCode = require(`!!raw-loader!../../packages/ngx-infinitegrid/stories/${folderName}/apps/Ngx${fileName}App/app.component.ts`).default;

  ngxComponentCode = ngxComponentCode.replace(/"(.+)\.css"/g, `"./app.component.css"`);
  const ngxHTMLCode = require(`!!raw-loader!../../packages/ngx-infinitegrid/stories/${folderName}/apps/Ngx${fileName}App/app.component.html`).default;
  const ngxModuleCode = require(`!!raw-loader!../../packages/ngx-infinitegrid/stories/apps/default/app.module.ts`).default;
  const vueCode = require(`!!raw-loader!../../packages/vue-infinitegrid/stories/${folderName}/apps/Vue${fileName}App.vue`).default;
  const svelteCode = require(`!!raw-loader!../../packages/svelte-infinitegrid/stories/${folderName}/apps/Svelte${fileName}App.svelte`).default;
