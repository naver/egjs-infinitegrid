...
<p>'Frame' is a printing term with the meaning that 'it fits in one row wide'. FrameInfiniteGrid is a grid that the item is filled up on the basis of a line given a size.</p>
...
|options|[FrameInfiniteGridOptions](FrameInfiniteGridOptions)|||<p>The option object of the FrameInfiniteGrid module </p>|
