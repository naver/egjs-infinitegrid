...
<p>MasonryInfiniteGrid is a grid that stacks items with the same width as a stack of bricks. Adjust the width of all images to the same size, find the lowest height column, and insert a new item.</p>
...
|options|[MasonryInfiniteGridOptions](MasonryInfiniteGridOptions)|||<p>The option object of the MasonryInfiniteGrid module </p>|
