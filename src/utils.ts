...
import { IJQuery, IRectlProperties, InnerSizeType, ClientSizeType, ScrollSizeType, OffsetSizeType, IItem, IGroup, IInfiniteGridGroup, IInfiniteGridItem } from "./types";
...
export function hasTarget<T>(target: T[], value: T) {
